 ...
 * @author TRIỆU TOÀN
 */
public class doThiTBMonView extends JPanel implements MouseListener, ActionListener {

    private Font font;
    private JLabel lblHocKi, lblNam;
    private JComboBox<String> cbbHocKy, cbbNam;
    private ChartPanel chartPanel;
    private doThiTBMonController doThiTBMonController = new doThiTBMonController();

    public doThiTBMonView() {
        this.setLayout(null);
        setUpViewPanel();
        setUpCharPanel();
    ...
    public void setUpViewPanel() {
        ...
        lblNam.setBounds(600, 580, 40, 25);

        cbbNam = new JComboBox<>();
        cbbNam.setBounds(640, 580, 100, 25);
        ...
        lblHocKi.setBounds(380, 580, 60, 25);

        cbbHocKy = new JComboBox<>();
        cbbHocKy.setMaximumRowCount(3);
        cbbHocKy.setBounds(440, 580, 100, 25);
    ...
    public void setUpCharPanel() {
        ...
        chartPanel = new ChartPanel(doThiTBMonController.createChart(cbbHocKy.getSelectedIndex() + 1, nam));
